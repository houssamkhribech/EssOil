...
def post():
    ...
    table_cooling_temp = [20, 22, 23, 24, 25, 28, 30, 32, 33, 34, 35, 38]  [("1", 20), ("2", 22), ("3", 23), ("4",24), ("5", 25), ("6", 28), ("7", 30), ("8",32), ("9", 33), ("10", 34), ("11", 35), ("12", 38)]                   # température du liquide de refroidissement en °C
