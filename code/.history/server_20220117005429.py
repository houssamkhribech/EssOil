...
def post():
    data = json.loads(request.get_data().decode('utf8'))
    table_tank_temp = [22, 25, 28, 30, 40, 50, 60, 65, 70, 90, 93, 94]                       # température dans la cuve °C
    table_cooling_temp = [20, 22, 23, 24, 25, 28, 30, 32, 33, 34, 35, 38]                    # température du liquide de refroidissement °C
    table_tank_pressure = [1000, 950, 900, 850, 800, 800, 800, 800, 800, 800, 800, 800]      # p
    return ''
