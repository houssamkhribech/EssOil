...
function RefreshExperiments() {
  $.ajax({
    ...
    success: function (answer) {
      ...
      var row = $("<tr>");
        row.append($('<th scop>').text('uid'));
        row.append($('<th scop>').text('Eau [mL]'));
        row.append($('<th scop>').text('Hydrolat [mL]'));
        row.append($('<th scop>').text('Pression [mbar]'));
        row.append($('<th scop>').text('Température [°C]'));
        row.append($('<th scop>').text('Plante'));
        row.append($('<th scop>').text('Référence'));
        row.append($('<th scop>').text('Masse plante [g]'));
        row.append($('<th scop>').text('Masse huile [g]'));
        row.append($('<th scop>').text('Stockage'));
        row.append($('<th scop>').text('Date'));
