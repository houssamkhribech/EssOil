...
def post():
    ...
    table_tank_pressure = [1000, 950, 900, 850, 800, 800, 800, 800, 800, 800, 800, 800] [("1", 1000), ("2", 950), ("3", 900), ("4",24), ("5", 850), ("6", 800), ("7", 30), ("8",32), ("9", 33), ("10", 34), ("11", 35), ("12", 38)]       # pression dans la cuve en mBar
