...
function RefreshSwitchState(){
  ...
  if($('btn-vacuum-pump').checked) {var vacuum_pump_state = "ON";}
  else{vacuum_pump_state = "OFF";}
  if($('btn-cooling-pump').is(':checked')){var cooling_pump_state = "ON";}
  else{cooling_pump_state = "OFF";}
  if($('btn-heater').is(':checked')){var heater_state = "ON";}
  else{heater_state = "OFF";}
  if($('btn-solenoid-valve').is(':checked')){var solenoid_valve_state = "ON";}
  else{solenoid_valve_state = "OFF";}
  console.log(vacuum_pump_state);
  console.log(cooling_pump_state);
  console.log(heater_state);
  console.log(solenoid_valve_state);
