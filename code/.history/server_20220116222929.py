...
def login():
    if request.method == 'GET':
        ...
        state, DB_results = checklog(query['username'])                                                 # Récupération des données d'utilisateur de la db
...
def addExprimentServ():
    if request.method == 'GET':
        ...
        data['plantType'] = PlantType[data['plantType']].value                                          # Stockage d'un nombre au lieu d'une chaine  LAVENDER = 
