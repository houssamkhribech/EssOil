...
def Initialize():
    ...
    ExecuteDatabase(db, 'CREATE TABLE IF NOT EXISTS switch_state' +
                    '(id INTEGER PRIMARY KEY AUTOINCREMENT, role INTEGER, matricule TEXT, lastname TEXT NOT NULL, firstname TEXT NOT NULL, mail TEXT NOT NULL, pass TEXT NOT NULL)')
    CloseDatabase(db)
