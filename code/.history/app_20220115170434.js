...
function RefreshExperiments() {
  $.ajax({
    ...
    success: function (answer) {
      ...
      var row = $("<tr>");
        row.append($('<th scope="row">').text('uid'));
        row.append($('<th scope="row">').text('Eau [mL]'));
        row.append($('<th scope="row">').text('Hydrolat [mL]'));
        row.append($('<th scope="row">').text('Pression [mbar]'));
        row.append($('<th scope="row">').text('Température [°C]'));
        row.append($('<th scope="row">').text('Plante'));
        row.append($('<th scope="row">').text('Référence'));
        row.append($('<th scope="row">').text('Masse plante [g]'));
        row.append($('<th scope="row">').text('Masse huile [g]'));
        row.append($('<th scope="row">').text('Stockage'));
        row.append($('<th scope="row">').text('Date'));
