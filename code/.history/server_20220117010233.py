...
def post():
    ...
    table_cooling_temp = [20, 22, 23, 24, 25, 28, 30, 32, 33, 34, 35, 38]  [("1", 22), ("2", 25), ("3", 28), ("4",30), ("5", 40), ("6", 50), ("7", 60), ("8",65), ("9",70), ("10", 90), ("11", 93), ("12", 94)]                   # température du liquide de refroidissement en °C
